## 目录
- [1.离散表示](#1离散表示)
  - [1.1 One-hot表示](#11-one-hot表示)
  - [1.2 词袋模型](#12-词袋模型)
  - [1.3 TF-IDF](#13-tf-idf)
  - [1.4 n-gram模型](#14-n-gram模型)
  - [1.5 离散表示存在的问题](#15-离散表示存在的问题)
- [2.分布式表示](#2-分布式表示)
  - [2.1 共现矩阵](#21-共现矩阵)
- [3.神经网络表示](#3神经网络表示)
  - [3.1 NNLM](#31-nnlm)
  - [3.2 Word2Vec](#32-word2vec)
  - [3.3 sense2vec](#33-sense2vec)
- [4.代码实现Word2Vec](https://github.com/mantchs/machine_learning_model/blob/master/Word2Vec/word2vec.ipynb)
